...
class S3DISDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # normalize
        selected_points = points[selected_point_idxs, :]  # num_point * 6 (coords + colors)
        ...
        # 2 = z coordinate of selected points (not normalized, probably because the data is rotated around the z during augmentation)
